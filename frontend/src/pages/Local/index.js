    ...
    <div className="box-container">
      ...
      <div className="content-container">
        ...
        <div className="content">
          ...
          <p>
            {" "}
            O link das apresentações e palestras serão mandados nos grupos ou
            pelo e-mail acadêmico{" "}
          </p>
          <p> Fique ligado! </p>
          <p>
            Em caso de dúvida, entre em contato pelas redes sociais:
            <br />
            <br />
            <a href="https://www.instagram.com/petinfouem/">@petinfouem</a>
            <br></br>
            <a href="https://www.facebook.com/petInformaticauem/">
              /petInformaticauem
            </a>
          </p>
        </div>
